...
void MPU6050_Init(void);  //init MPU6050 but no others function,not include IICinit
void MPUInit(void); //using software IIC and open motion detection,not include IICinit
